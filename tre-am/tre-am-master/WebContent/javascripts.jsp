    ...
    <script src='${pageContext.request.contextPath}/js/a076d05399.js'></script>
    <script src="${pageContext.request.contextPath}/js/customPagination.js"></script>
    <script src="${pageContext.request.contextPath}/js/customListTable.js"></script>
    <script src="${pageContext.request.contextPath}/js/helperJS.js"></script>
